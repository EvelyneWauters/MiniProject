...
<nav class="navbar navbar-trans navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand text-danger" href="#">let's move to Hollywood</a>
    </div>
    <div class="navbar-collapse collapse" id="navbar-collapsible">
      <ul class="nav navbar-nav navbar-left">
        <li><a href="#section1">Start</a></li>
        <li><a href="#section2">Top movies</a></li>
        <li><a href="#section3">Movies</a></li>
        <li><a href="#section4">Actors</a></li>
        <li><a href="#section5">Register</a></li>
        <li><a href="#section6">Login</a></li>
        <li>&nbsp;</li>
      </ul>
...
<section class="container-fluid" id="section1">
  <div class="v-center">
    <h1 class="text-center">Starstruck in Hollywood</h1>
    <h2 class="text-center lato animate slideInDown">The smallest <b>movie database</b> (so far)</h2>
    <p class="text-center">
      <br>
      <a href="#" class="btn btn-danger btn-lg btn-huge lato" data-toggle="modal" data-target="#myModal">Get Free Membership While You Can</a>
    </p>
  </div>
  <a href="#section2">
          ...
          <div class="col-sm-12 text-center">
            <div class="panel panel-default slideInLeft animate">
              <div class="panel-heading">
                <h3>Latest movienews</h3></div>
              <div class="panel-body">
                <p>We're working on the latest releases, if only typing MySQL-input data was friendlier </p>
                <hr>GO
                <hr>
              </div>
            </div>
